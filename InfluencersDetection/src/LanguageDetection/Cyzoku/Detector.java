...
import LanguageDetection.Cyzoku.util.NGram;
...
public class Detector {
     ...
     *
     * @param factory {@link DetectorFactory} instance (only DetectorFactory
     * inside)
     */
     ...
     * @throws LangDetectException code = ErrorCode.CantDetectError : Can't
     * detect because of no valid features in text
     */
