...
public class GeneralController implements Statistics, LongTask {
    ...
    public void execute(GraphModel graphModel, AttributeModel attributeModel) {
        ...
        //removes any existing node label
        for (Node node : graph.getNodes().toArray()) {
            Integer modularity = (Integer) node.getNodeData().getAttributes().getValue("Modularity Class");
            if (modularity != null && modularity > 1000) {
        ...
        try {
            ...
            //writes roles and community labels to Data Laboratory
    ...
    public String getReport() {
        ...
        sb.append("<h2><b>Main Communities (at least " + minCommunitySize + " members)</b></h2><br/>");
        sb.append("<br/>");
