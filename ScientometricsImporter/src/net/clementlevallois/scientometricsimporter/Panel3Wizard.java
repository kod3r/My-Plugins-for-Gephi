...
public class Panel3Wizard implements WizardDescriptor.Panel<WizardDescriptor>, PropertyChangeListener {
    ...
    public Component getComponent() {
        if (component == null) {
            ...
            panel3.jLabelFirstConnectedAgent.setText(MyFileImporter.getFirstConnectedAgent());
            panel3.jLabelSecondConnectedAgent.setText(MyFileImporter.getSecondConnectedAgent());
            component = panel3;
