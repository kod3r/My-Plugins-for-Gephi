 ...
 */
public class Panel1Wizard implements WizardDescriptor.Panel<WizardDescriptor>, PropertyChangeListener {
...
//        data.putProperty("headers", getComponent().getHeaders().toString());
    }
}
